      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6">
        ...
        <div className="hidden items-center gap-3 md:flex">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="rounded-full border border-ink/20 px-4 py-2 text-sm font-semibold text-ink/80 transition hover:bg-ink hover:text-cream"
          >
            Contáctanos
          </a>
          <a
        ...
        <div className="border-t border-black/5 bg-cream px-4 pb-5 md:hidden">
          ...
          <div className="mt-3 flex flex-col gap-2">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="rounded-full border border-ink/20 px-4 py-2.5 text-center text-sm font-semibold text-ink/80"
            >
              Contáctanos
            </a>
            <a
